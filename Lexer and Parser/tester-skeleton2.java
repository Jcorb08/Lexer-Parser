...
class Main {
	...
	System.out.println ( "\n" ); 
        ...
        } catch (Exception e){System.out.println("main lex");
        } 
        try {
            System.out.println("lexing");
            System.out.println(l.lex("()"));
        ...
        try {
            System.out.println("lexing");
            System.out.println(l.lex("if"));
        } catch (Exception e){System.out.println("main lex");
        } 
        try {
            System.out.println("lexing");
            System.out.println(l.lex("if983Ff"));
        } catch (Exception e){System.out.println("main lex");
        }
        try {
            System.out.println("lexing");
            System.out.println(l.lex("654783"));
        } catch (Exception e){System.out.println("main lex");
        }
        try {
            System.out.println("lexing");
            System.out.println(l.lex("654783gh:==fgF;break/def;if"));
        } catch (Exception e){System.out.println("main lex");
        }
        try {
            System.out.println("lexing");
        ...
        try {
            System.out.println("lexing");
            System.out.println(l.lex("def skip if then else while do repeat until break continue"));
        } catch (Exception e){System.out.println("main lex");
        }
        try {
            System.out.println("lexing");
